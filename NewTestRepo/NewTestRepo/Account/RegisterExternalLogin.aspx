<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="NewTestRepo.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="NewTestRepo" %>
