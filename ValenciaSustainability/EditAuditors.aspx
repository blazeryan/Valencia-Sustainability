...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ValenciaSustainabilityDatabaseConnectionString %>" DeleteCommand="DELETE FROM [Auditor] WHERE [AuditorID] = @AuditorID" InsertCommand="INSERT INTO [Auditor] ([AuditorFirstName], [AuditorMiddleName], [AuditorLastName], [AuditorEmail], [AuditorPhoneNumber]) VALUES (@AuditorFirstName, @AuditorMiddleName, @AuditorLastName, @AuditorEmail, @AuditorPhoneNumber)" SelectCommand="SELECT [AuditorID], [AuditorFirstName], [AuditorMiddleName], [AuditorLastName], [AuditorEmail], [AuditorPhoneNumber] FROM [Auditor]" UpdateCommand="UPDATE [Auditor] SET [AuditorFirstName] = @AuditorFirstName, [AuditorMiddleName] = @AuditorMiddleName, [AuditorLastName] = @AuditorLastName, [AuditorEmail] = @AuditorEmail, [AuditorPhoneNumber] = @AuditorPhoneNumber WHERE [AuditorID] = @AuditorID">
            <DeleteParameters>
